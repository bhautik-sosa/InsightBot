...
//     const names = getSheet("LoanTransactions");
//     console.log(names);
...
//     //         // 1️⃣ LoanTransaction
//     //         // ==========================================================
//     //         const loanRows = getSheet("LoanTransaction");

//     //         for (const row of loanRows) {
//     //             await tx.loanTransaction.create({
//     //                 data: {
//     //                     id: Number(row.id), // preserve original id
//     //                     userId: row.userId,
...
//     //         console.log("✅ LoanTransaction inserted");

//     //         // ==========================================================
//     //         // 2️⃣ BankingEntity
//     //         // ==========================================================
//     //         const bankingRows = getSheet("BankingEntity");

//     //         for (const row of bankingRows) {
//     //             await tx.bankingEntity.create({
//     //                 data: {
//     //                     id: Number(row.id),
//     //                     mandateBank: row.mandateBank,
//     //                     disbursementBank: row.disbursementBank,
//     //                     salary: row.salary
//     //                         ? new Prisma.Decimal(row.salary)
//     //                         : null,
...
//     //         console.log("✅ BankingEntity inserted");

//     //         // ==========================================================
//     //         // 3️⃣ EmiEntity
//     //         // ==========================================================
//     //         const emiRows = getSheet("EmiEntity");

//     //         for (const row of emiRows) {
//     //             await tx.emiEntity.create({
//     //                 data: {
//     //                     id: Number(row.id),
...
//     //                     loanId: Number(row.loanId),
//     //                     userId: row.userId,
//     //                     principalCovered: Number(row.principalCovered),
//     //                     interestCalculate: Number(row.interestCalculate),
//     //                     payType: row.payType,
...
//     //         console.log("✅ EmiEntity inserted");

//     //         // ==========================================================
//     //         // 4️⃣ TransactionEntity
//     //         // ==========================================================
//     //         const transactionRows = getSheet("TransactionEntity");

//     //         for (const row of transactionRows) {
//     //             await tx.transactionEntity.create({
//     //                 data: {
//     //                     id: Number(row.id),
...
//     //         console.log("✅ TransactionEntity inserted");
//     //     });
